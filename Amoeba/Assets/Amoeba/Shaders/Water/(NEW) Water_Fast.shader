    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float4 node_1952 = _Time;
                float2 node_5254 = (o.uv0+node_1952.g*float2(0,1));
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float4 node_1952 = _Time;
                float2 node_5254 = (i.uv0+node_1952.g*float2(0,1));
...
/////// Diffuse:
                ...
                float2 node_1321 = (i.uv0+node_1952.g*float2(0,1));
...
/// Final Color:
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                o.uv0 = v.texcoord0;
                o.normalDir = UnityObjectToWorldNormal(v.normal);
                float4 node_108 = _Time;
                float2 node_5254 = (o.uv0+node_108.g*float2(0,1));
                float4 _node_8735_var = tex2Dlod(_node_8735,float4(TRANSFORM_TEX(node_5254, _node_8735),0.0,0));
                float2 node_213 = (_node_8735_var.rgb.rg*_node_2425);
                v.vertex.xyz += float3(node_213,0.0);
                o.posWorld = mul(unity_ObjectToWorld, v.vertex);
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float3 normalDirection = i.normalDir;
                float4 node_108 = _Time;
                float2 node_5254 = (i.uv0+node_108.g*float2(0,1));
                float4 _node_8735_var = tex2D(_node_8735,TRANSFORM_TEX(node_5254, _node_8735));
                float2 node_213 = (_node_8735_var.rgb.rg*_node_2425);
                float2 sceneUVs = (i.projPos.xy / i.projPos.w) + node_213;
                float4 sceneColor = tex2D(_GrabTexture, sceneUVs);
...
/////// Diffuse:
                NdotL = max(0.0,dot( normalDirection, lightDirection ));
                float3 directDiffuse = max( 0.0, NdotL) * attenColor;
                float2 node_1321 = (i.uv0+node_108.g*float2(0,1));
                float4 _node_6901_var = tex2D(_node_6901,TRANSFORM_TEX(node_1321, _node_6901));
                float3 diffuseColor = (_node_6901_var.rgb*_node_8939.rgb);
...
/// Final Color:
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                VertexOutput o = (VertexOutput)0;
                o.uv0 = v.texcoord0;
                float4 node_4857 = _Time;
                float2 node_5254 = (o.uv0+node_4857.g*float2(0,1));
                float4 _node_8735_var = tex2Dlod(_node_8735,float4(TRANSFORM_TEX(node_5254, _node_8735),0.0,0));
                float2 node_213 = (_node_8735_var.rgb.rg*_node_2425);
                v.vertex.xyz += float3(node_213,0.0);
                o.pos = UnityObjectToClipPos( v.vertex );
