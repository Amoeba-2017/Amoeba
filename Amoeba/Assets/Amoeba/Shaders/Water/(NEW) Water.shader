...
/*SF_DATA;ver:1.38;sub:START;pass:START;ps:flbk:,iptp:0,cusa:False,bamd:0,cgin:,lico:1,lgpr:1,limd:1,spmd:1,trmd:0,grmd:0,uamb:True,mssp:True,bkdf:False,hqlp:False,rprd:False,enco:False,rmgx:True,imps:True,rpth:0,vtps:0,hqsc:True,nrmq:1,nrsp:0,vomd:0,spxs:False,tesm:0,olmd:1,culm:0,bsrc:0,bdst:1,dpts:2,wrdp:False,dith:0,atcv:False,rfrpo:True,rfrpn:Refraction,coma:15,ufog:True,aust:True,igpj:True,qofs:0,qpre:3,rntp:2,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.5,fgcg:0.5,fgcb:0.5,fgca:1,fgde:0.01,fgrn:0,fgrf:300,stcl:False,atwp:False,stva:128,stmr:255,stmw:255,stcp:6,stps:0,stfa:0,stfz:0,ofsf:0,ofsu:0,f2p0:False,fnsp:False,fnfb:False,fsmp:False;n:type:ShaderForge.SFN_Final,id:6558,x:33752,y:32940,varname:node_6558,prsc:2|diff-5769-OUT,spec-8306-RGB,alpha-4919-OUT,refract-213-OUT,voffset-213-OUT;n:type:ShaderForge.SFN_Tex2d,id:6901,x:33223,y:32890,ptovrint:False,ptlb:node_6901,ptin:_node_6901,varname:node_6901,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,tex:2f74fe10b0b088747b3d6a1218156cb3,ntxv:0,isnm:False|UVIN-1321-UVOUT;n:type:ShaderForge.SFN_Color,id:8939,x:33339,y:33094,ptovrint:False,ptlb:node_8939,ptin:_node_8939,varname:node_8939,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,c1:0.2901961,c2:0.3960784,c3:0.5019608,c4:1;n:type:ShaderForge.SFN_Multiply,id:5769,x:33523,y:32980,varname:node_5769,prsc:2|A-6901-RGB,B-8939-RGB;n:type:ShaderForge.SFN_ComponentMask,id:7946,x:33313,y:33301,varname:node_7946,prsc:2,cc1:0,cc2:1,cc3:-1,cc4:-1|IN-8735-RGB;n:type:ShaderForge.SFN_Panner,id:5254,x:32929,y:33092,varname:node_5254,prsc:2,spu:1,spv:1|UVIN-5933-UVOUT,DIST-1398-OUT;n:type:ShaderForge.SFN_Slider,id:3174,x:32587,y:33484,ptovrint:False,ptlb:node_3174,ptin:_node_3174,varname:node_3174,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:-3,cur:1,max:3;n:type:ShaderForge.SFN_Tex2d,id:8735,x:33126,y:33186,ptovrint:False,ptlb:node_8735,ptin:_node_8735,varname:node_8735,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,tex:28c7aad1372ff114b90d330f8a2dd938,ntxv:0,isnm:False|UVIN-5254-UVOUT;n:type:ShaderForge.SFN_Vector1,id:4919,x:33544,y:33203,varname:node_4919,prsc:2,v1:0.5;n:type:ShaderForge.SFN_Time,id:9215,x:32543,y:33328,varname:node_9215,prsc:2;n:type:ShaderForge.SFN_Multiply,id:213,x:33544,y:33364,varname:node_213,prsc:2|A-7946-OUT,B-2425-OUT;n:type:ShaderForge.SFN_Multiply,id:1398,x:32817,y:33295,varname:node_1398,prsc:2|A-9215-TSL,B-3174-OUT;n:type:ShaderForge.SFN_TexCoord,id:5933,x:32674,y:33174,varname:node_5933,prsc:2,uv:0,uaff:False;n:type:ShaderForge.SFN_Slider,id:2425,x:33289,y:33576,ptovrint:False,ptlb:node_2425,ptin:_node_2425,varname:node_2425,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:-3,cur:0.1593571,max:3;n:type:ShaderForge.SFN_Color,id:8306,x:33510,y:32780,ptovrint:False,ptlb:node_8306,ptin:_node_8306,varname:node_8306,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,c1:0.8970588,c2:0.8179976,c3:0.3759732,c4:1;n:type:ShaderForge.SFN_Panner,id:1321,x:32985,y:32836,varname:node_1321,prsc:2,spu:0,spv:1|UVIN-1971-UVOUT,DIST-7502-OUT;n:type:ShaderForge.SFN_TexCoord,id:1971,x:32762,y:32725,varname:node_1971,prsc:2,uv:0,uaff:False;n:type:ShaderForge.SFN_Divide,id:7502,x:32778,y:32921,varname:node_7502,prsc:2|A-3807-TSL,B-985-OUT;n:type:ShaderForge.SFN_RemapRange,id:985,x:32570,y:32986,varname:node_985,prsc:2,frmn:0,frmx:1,tomn:-1,tomx:1|IN-2438-OUT;n:type:ShaderForge.SFN_Slider,id:2438,x:32230,y:33055,ptovrint:False,ptlb:node_2438,ptin:_node_2438,varname:node_2438,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:0.3675214,max:1;n:type:ShaderForge.SFN_Time,id:3807,x:32387,y:32873,varname:node_3807,prsc:2;proporder:6901-8939-3174-8735-2425-8306-2438;pass:END;sub:END;*/
...
Shader "Custom/waterfall" {
    Properties {
        ...
        _node_2438 ("node_2438", Range(0, 1)) = 0.3675214
    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float2 node_5254 = (o.uv0+(node_9215.r*_node_3174)*float2(1,1));
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float4 node_9215 = _Time;
                float2 node_5254 = (i.uv0+(node_9215.r*_node_3174)*float2(1,1));
...
/////// Diffuse:
                ...
                float2 node_1321 = (i.uv0+(node_3807.r/(_node_2438*2.0+-1.0))*float2(0,1));
